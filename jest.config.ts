...
const config: Config = {
    ...
    moduleNameMapper: {
        ...
        "^spikypanda-applications-microg$":      "<rootDir>/packages/dev/applications/privates/microg/src/index.ts",
        "^spikypanda-applications-microg/(.*)$": "<rootDir>/packages/dev/applications/privates/microg/src/$1",
        ...
        "^spikypanda-plugin-geometry$":          "<rootDir>/packages/dev/plugins/geometry/src/index.ts",
        "^spikypanda-plugin-geometry/(.*)$":     "<rootDir>/packages/dev/plugins/geometry/src/$1",
