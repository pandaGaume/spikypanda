import type { IDisposable, Nullable } from "../types";
...
export class EventState {
     ...
     */
    constructor(mask: number, skipNextObservers = false, target?: unknown, currentTarget?: unknown) {
     ...
     */
    public initialize(mask: number, skipNextObservers = false, target?: unknown, currentTarget?: unknown): EventState {
        this.mask = mask;
     ...
     */
    public lastReturnValue?: unknown;

    /**
     * User defined information that will be sent to observers
     */
    public userInfo?: unknown;
}

/**
 * Represent an Observer registered to a given Observable object.
 */
export class Observer<T> implements IDisposable {
    /** @internal */
...
export class Observable<T> {
     ...
     * @returns the new observer created for the callback
     */
    public addOnce(callback: (eventData: T, eventState: EventState) => void): Nullable<IDisposable> {
     ...
     * @returns false if it doesn't belong to this Observable
     */
    public removeCallback(callback: (eventData: T, eventState: EventState) => void, scope?: unknown): boolean {
     ...
     */
    public notifyObservers(eventData: T, mask: number = -1, target?: unknown, currentTarget?: unknown, userInfo?: unknown): boolean {
