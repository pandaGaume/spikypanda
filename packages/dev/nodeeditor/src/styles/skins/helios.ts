...
export const heliosSkin: Skin = {
    ...
    "--ne-color-bg":                "#0A0A0F",
    "--ne-color-surface":           "#14141C",
    "--ne-color-surface-faint":     "rgba(20, 20, 28, 0.4)",
    "--ne-color-surface-strong":    "rgba(20, 20, 28, 0.85)",
    "--ne-color-surface-popover":   "rgba(20, 20, 28, 0.97)",
    "--ne-color-node-header":       "#1B1B25",

    "--ne-color-recessed-1":        "rgba(0, 0, 0, 0.20)",
    "--ne-color-recessed-2":        "rgba(0, 0, 0, 0.35)",
    "--ne-color-recessed-3":        "rgba(0, 0, 0, 0.55)",

    "--ne-color-border":            "#2A2A35",
    "--ne-color-border-soft":       "rgba(42, 42, 53, 0.5)",
    "--ne-color-border-strong":     "#3A3A48",
