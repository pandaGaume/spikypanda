import { editable, viewable, cloneable, IOlink, IDeclaresPorts, IPortDescriptor, ISession, IChannel, RuntimeNode } from "spikypanda-core";
...
export class ClockNode extends RuntimeNode implements IDeclaresPorts {
    ...
    public readonly outputPorts: ReadonlyArray<IPortDescriptor> = [{ slot: "t", optional: false, type: "float" }];
...
export class DeltaTimeNode extends RuntimeNode implements IDeclaresPorts {
    ...
    public readonly inputPorts: ReadonlyArray<IPortDescriptor> = [];
    public readonly outputPorts: ReadonlyArray<IPortDescriptor> = [{ slot: "dt", optional: false, type: "float" }];
