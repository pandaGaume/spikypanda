...
import {
    MakeArrayNode, ArrayLengthNode, ArrayClearNode, ArrayShuffleNode,
    ArrayReverseNode, ArraySortNode, ArrayAddNode, ArrayInsertNode,
    ArraySetNode, ArrayGetNode, ArrayRemoveNode, ArrayRemoveIndexNode,
    ArrayContainsNode, ArrayFindNode,
} from "../nodes/array.js";
...
export const logicArraySubPlugin: IPlugin = {
    activate(ctx: IPluginContext): void {
        ctx.nodes.register("Logic.Array:makeArray", () => new MakeArrayNode() as never, {
            label: "Make Array", category: "Logic.Array",
        ...
        ctx.nodes.register("Logic.Array:clear", () => new ArrayClearNode() as never, {
            ...
            inputPorts: [ARRAY_IN], outputPorts: [ARRAY_INOUT], standards: UE5,
        });
        ...
        ctx.nodes.register("Logic.Array:add", () => new ArrayAddNode() as never, {
            ...
            inputPorts: [ARRAY_IN, ITEM_IN], outputPorts: [ARRAY_INOUT], standards: UE5,
        });
        ctx.nodes.register("Logic.Array:insert", () => new ArrayInsertNode() as never, {
            label: "Insert", category: "Logic.Array",
            inputPorts: [ARRAY_IN, INDEX_IN, ITEM_IN], outputPorts: [ARRAY_INOUT], standards: UE5,
        });
        ...
        ctx.nodes.register("Logic.Array:removeIndex", () => new ArrayRemoveIndexNode() as never, {
            ...
            inputPorts: [ARRAY_IN, INDEX_IN], outputPorts: [ARRAY_INOUT], standards: UE5,
        });
