...
export class GearMeshNode extends RuntimeNode implements IDeclaresPorts {
    ...
    @editable("number") public get nTeeth(): number { return this._nTeeth; }
    public set nTeeth(v: number) { this.setField("nTeeth", this._nTeeth, v, (n) => { this._nTeeth = n; }); }
    @editable("number") public get meshAmp(): number { return this._meshAmp; }
    public set meshAmp(v: number) { this.setField("meshAmp", this._meshAmp, v, (n) => { this._meshAmp = n; }); }
    @editable("number") public get toothAmp(): number { return this._toothAmp; }
    public set toothAmp(v: number) { this.setField("toothAmp", this._toothAmp, v, (n) => { this._toothAmp = n; }); }
    @editable("number") public get faultAngle(): number { return this._faultAngle; }
    public set faultAngle(v: number) { this.setField("faultAngle", this._faultAngle, v, (n) => { this._faultAngle = n; }); }
    @editable("number") public get pulseWidth(): number { return this._pulseWidth; }
    public set pulseWidth(v: number) { this.setField("pulseWidth", this._pulseWidth, v, (n) => { this._pulseWidth = n; }); }
