...
export class ShaftUnbalanceNode extends RuntimeNode implements IDeclaresPorts {
    ...
    @viewable("number") public get theta(): number      { return this._theta; }

    public override reset(_session: ISession): void {
        this.setField("signal_out", this._out,   0, (n) => { this._out = n; });
        this.setField("theta",      this._theta, 0, (n) => { this._theta = n; });
        this._lastT = -1;
    }
    ...
    public override fire(session: ISession, t: number): void {
        ...
        this.setField("theta",      this._theta, this._theta, (n) => { this._theta = n; });
